...
## Descripción
<p>
  Este proyecto fue desarrollado como un sistema gratuito para una primaria, la cual requería ayuda para la gestión de calificaciones y resultados de evaluaciones, además de la generación de documentos con estos resultados. El sistema fue realizado utilizando C# y una base de datos en MySQL.
  <br><br>
...
- Generación de documento de calificaciones
- Generación de documento y gráfica de nivel de desempeño de evaluaciones SisAT
